...
Err_Renamed: 
	...
	Private Sub frmMain_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		...
		For i = 1 To 5
			...
			'UPGRADE_WARNING: MSComctlLib.ButtonMenus メソッド tlbMenu.Buttons.ButtonMenus.Add には新しい動作が含まれます。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"' をクリックしてください。
			Call tlbMenu.Items.Item("Open").ButtonMenus.Add(New System.Windows.Forms.ToolStripMenuItem(i,  , "&" & i & ":"))
			'UPGRADE_ISSUE: MSComctlLib.ButtonMenu プロパティ tlbMenu.Buttons.ButtonMenus はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
			'UPGRADE_WARNING: コレクション tlbMenu.Buttons().ButtonMenus の下限が 1 から 0 に変更されました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"' をクリックしてください。
	...
	Public Sub frmMain_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
		...
		'UPGRADE_NOTE: PADDING は PADDING_Renamed にアップグレードされました。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"' をクリックしてください。
		...
		With Me
			...
			With tlbMenu.Items.Item("Viewer")
				'UPGRADE_ISSUE: MSComctlLib.Button プロパティ tlbMenu.Buttons.Width はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
				.Width = VB6.PixelsToTwipsX(fraViewer.Width)
                'UPGRADE_ISSUE: MSComctlLib.Button プロパティ tlbMenu.Buttons.Top はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
                'UPGRADE_ISSUE: MSComctlLib.Button プロパティ tlbMenu.Buttons.left はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
...
Err_Renamed: 
    ...
    Public Sub mnuOptionsItem_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles _mnuOptionsItem_0.Click, _mnuOptionsItem_1.Click, _mnuOptionsItem_2.Click, _mnuOptionsItem_3.Click, _mnuOptionsItem_4.Click, _mnuOptionsItem_5.Click, _mnuOptionsItem_6.Click, _mnuOptionsItem_7.Click
    ...
    Public Sub mnuTheme_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles _mnuTheme_0.Click
    ...
    Public Sub mnuViewItem_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles _mnuViewItem_0.Click, _mnuViewItem_1.Click, _mnuViewItem_2.Click
        Select Case DirectCast(eventSender, ToolStripMenuItem).Name
...
Err_Renamed: 
    ...
    Public Sub mnuEditMode_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles _mnuEditMode_0.Click, _mnuEditMode_1.Click, _mnuEditMode_2.Click
...
Err_Renamed:
    ...
    Public Sub mnuLanguage_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles _mnuLanguage_0.Click
...
Err_Renamed: 
    ...
    Public Sub mnuRecentFiles_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles _mnuRecentFiles_0.Click, _mnuRecentFiles_1.Click, _mnuRecentFiles_2.Click, _mnuRecentFiles_3.Click, _mnuRecentFiles_4.Click, _mnuRecentFiles_5.Click, _mnuRecentFiles_6.Click, _mnuRecentFiles_7.Click, _mnuRecentFiles_8.Click, _mnuRecentFiles_9.Click
        Dim strArray() As String
...
Err_Renamed: 
    ...
    Private Sub optChangeBottom_CheckedChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles _optChangeBottom_0.CheckedChanged, _optChangeBottom_1.CheckedChanged, _optChangeBottom_2.CheckedChanged, _optChangeBottom_3.CheckedChanged, _optChangeBottom_4.CheckedChanged
    ...
    Private Sub optChangeTop_CheckedChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles _optChangeTop_0.CheckedChanged, _optChangeTop_1.CheckedChanged, _optChangeTop_2.CheckedChanged
        If eventSender.Checked Then
...
Err_Renamed: 
	...
	Public Sub picMain_MouseMove(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles picMain.MouseMove
		...
		If Not g_SelectArea.blnFlag Then '選択範囲なし
			...
			If Button = VB6.MouseButtonConstants.LeftButton And tlbMenu.Items.Item("Edit").Checked = True And g_Obj(UBound(g_Obj)).intCh <> 0 Then 'オブジェ移動中
...
Err_Renamed: 
	...
	Private Sub tlbMenu_ButtonMenuClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles tlbMenu.ButtonMenuClick
		...
		'UPGRADE_ISSUE: MSComctlLib.ButtonMenu プロパティ ButtonMenu.Parent はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
		If ButtonMenu.Parent.Text = tlbMenu.Items.Item("Open").Text Then

            'UPGRADE_ISSUE: MSComctlLib.ButtonMenu プロパティ ButtonMenu.Index はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
            Select Case (ButtonMenu.Index - 1)
                Case 0
                    Call mnuRecentFiles_Click(_mnuRecentFiles_0, New System.EventArgs())
                Case 1
